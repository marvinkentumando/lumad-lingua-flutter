...
class _SentimentDashboardScreenState extends ConsumerState<SentimentDashboardScreen> {
      ...
      body: AmbientTopoBackground(
        ...
        child: SafeArea(
          ...
          child: sentimentAsync.when(
            ...
            error: (e, _) => Center(child: Text('Monitor Error: $e', style: const TextStyle(color: Colors.white))),
          ),
        ),
      ),
    );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildVitalityGauge(vitalityPercent, avgScore),
                const SizedBox(height: 32),
                _buildInsightGrid(data),
                const SizedBox(height: 32),
                _buildKeywordCloud(data),
                const SizedBox(height: 32),
                _buildSectionHeader('Live Sentiment Stream'),
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) => _buildSentimentCard(data[index], index)
  ...
  Widget _buildVitalityGauge(double percent, double score) {
  ...
  Widget _buildInsightGrid(List<SentimentData> data) {
  ...
  Widget _buildKeywordCloud(List<SentimentData> data) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('Dominant Keywords'),
        const SizedBox(height: 16),
        Wrap(
          spacing: 12,
          runSpacing: 12,
          children: sorted.take(10).map((entry) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: isPopular ? AppColors.gold500 : Colors.white10,
              ...
              child: Text(
                entry.key,
                style: AppTypography.body.copyWith(
                  color: isPopular ? Colors.black : Colors.white70,
  ...
  Widget _buildSentimentCard(SentimentData data, int index) {
