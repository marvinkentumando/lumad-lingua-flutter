          ...
          builder: (context, setDialogState) {
            Future<void> sendResetLink() async {
              ...
              if (email.isEmpty || !email.contains('@')) {
                setDialogState(() {
                  dialogError = l10n.translate('invalid_email_format');
                });
                return;
              }
              ...
              try {
                ...
                if (context.mounted) {
                  setDialogState(() {
                    isSending = false;
                    dialogError = l10n.getAuthErrorMessage(e);
                  });
                }
              }
            }
            ...
            return AlertDialog(
                  ...
                  children: [
                    ...
                    if (dialogError != null) ...[
                      Container(
                        ...
                        child: Text(
                          dialogError!,
                          style: AppTypography.label.copyWith(color: AppColors.semanticRed, fontSize: 12),
                          textAlign: TextAlign.center,
                        ),
                      ),
                    ],
              ...
              actions: [
                ...
                BrandButton(
                  text: isSending ? l10n.translate('waiting') : l10n.translate('send_reset_link'),
                  type: BrandButtonType.primary,
                  onTap: isSending ? null : sendResetLink,
                ),
              ],
            );
          },
